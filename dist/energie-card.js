  ...
  render() {
    ...
    const schemas = [
      ...
      [ // STYLE
        ...
        { name: "size_val", label: "Taille Gros Chiffres", selector: { number: { min: 12, max: 50, mode: "slider" } } },
      ...
      <ha-card style="border-color: ${cardStatusColor}66">
        ...
        <div class="main-stats">
          <div class="stat-box ${solar < 10 ? 'dimmed' : ''}">
            ...
            <span class="label" style="color: #00ff88; font-size: ${c.size_label || 8}px; font-weight: bold;">+${hGain.toFixed(3)}€/h</span>
          </div>
          ...
          <div class="stat-box">
            ...
            <span class="label" style="color: #ff4d4d; font-size: ${c.size_label || 8}px; font-weight: bold;">-${hCost.toFixed(3)}€/h</span>
          </div>
        </div>
